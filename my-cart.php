...
?>
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
								...
								<input type="text" id="sizeInput" value="<?php echo $_SESSION['cart'][$row['id']]['size']; ?>" name="size[<?php echo $row['id']; ?>]">
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total Price<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
